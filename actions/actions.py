...
ACTIONS_DATA = {
    "tải phần mềm": {
        "name": "<b>Phần mềm Quản Lý Hụi</b> của chúng tôi chạy trên nền tảng web nên bạn không cần tải về để sử dụng. Để truy cập vào phần mềm Quản Lý Hụi, bạn hãy làm theo các bước sau:",
        "details": "<b>Bước 1:</b> Bạn hãy mở trình duyệt web (Cốc Cốc, Chrome, Edge,...). <br><br>" +
                   "<b>Bước 2:</b> Truy cập vào địa chỉ <b>'phanmemhui.com'</b>.<br><br>" +
                   "<b>Bước 3:</b> Tiếp đến, bạn hãy bấm vào nút 'MỞ PHẦN MỀM QUẢN LÝ HỤI' màu xanh lá.",
        "link": ""
    },
    "sử dụng phần mềm": {
        "name": "sử dụng phần mềm",
        "details": "Chào bạn, chúng tôi có đăng rất nhều video hướng dẫn sử dụng <b>Phần mềm Quản Lý Hụi</b> bên kênh Youtube. Bạn hãy truy câp vào kênh Youtube bên dưới để xem các video hướng dẫn sử dụng phần mềm nhé:",
        "link": "https://www.youtube.com/@congtyphanmemtotnhat8496/shorts"
    },
    "hốt hụi": {
        "name": "hốt hụi",
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   "<b>Bước 2:</b> Chọn <b>dây hụi cần hốt</b>. <br><br>"
                   "<b>Bước 3:</b> Bấm vào nút <b>HỐT HỤI</b>. <br><br>"
                   "<b>Bước 4:</b> Bạn hãy chọn <b>Người hốt</b>. Sau đó <b>Ghi tiền thăm</b>. Chọn ngày hốt rồi bấm <b>OK</b><br>"
                   "(chỗ ngày hốt có thể lùi ngày nếu cho hốt lại các kỳ cũ) <br><br>"
                   "<b>Bước 5:</b> Sau khi đã điền đầy đủ thông tin, bạn hãy bấm <b>XÁC NHẬN HỐT HỤI</b>. Phần mềm sẽ tính số tiền hụi viên cần đóng, bạn hãy chờ vài giây cho phần mềm xử lý xong nhé. <br><br>"
                   ...
                   "(Bạn có thể chọn chia sẽ qua Zalo hoặc Messager cho khách hàng)<br><br>"
    ...
    "đóng hụi": {
        ...
        "details": "<b>Bước 1:</b> Bấm vào mục <b>Hụi cần đóng trong ngày </b> <br><br>"
                   "<b>Bước 2:</b> Chọn <b>Xem dữ liệu</b>. Phần mềm sẽ tải các dữ liệu hụi viên cần đóng, bạn hãy chờ vài giây cho phần mềm xử lý xong nhé. <br><br>"
    ...
    "in tất cả bill đóng trong ngày": {
        ...
        "details": "<b>Bước 1:</b> Chọn vào <b>HỤI CẦN ĐÓNG</b>.<br><br>"
                   "<b>Bước 2:</b> Bấm nút <b>IN TẤT CẢ</b> màu xanh dương. Phần mềm sẽ hiện thị tất cả các bill trong ngày, phần mềm sẽ vài giây để xử lý, <b>bạn hãy chờ đến khi thanh màu xanh lá phía dưới biến mất hãy thao tác tiếp nhé</b>.<br><br>"
                   "<b>Bước 3:</b> Bấm vào nút <b>Chia sẽ ZALO</b> để chia sẽ bill đóng.<br>"
                   "(Bạn có thể chọn chia sẽ qua Zalo hoặc Messager cho khách hàng)",
    ...
    "thêm số phần hụi trong dây hụi": {
        ...
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   ...
                   "<b>Bước 3:</b> Chỉnh <b>Số phần (kỳ hốt)</b> lại theo nhu cầu của bạn. Sau đó bấm vào <b>Dấu + màu xanh lá</b>.<br><br>"
    ...
    "giảm số phần hụi trong dây hụi": {
        ...
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   ...
                   "<b>Bước 4:</b> Chỉnh <b>Số phần (kỳ hốt)</b> lại theo nhu cầu của bạn.<br><br>"
                   "<b>Bước 5:</b> Bấm <b>LƯU THÔNG TIN</b> để hoàn tất.",
        "link": "https://www.youtube.com/shorts/Yuup3Vt0YWU"
    },
    ...
    "hốt hụi nhiều người cùng kỳ": {
        ...
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   ...
                   "(Sau đó bạn có thể bấm vào <b>IN TOA HỐT</b> để chia sẽ phiếu hốt. Bấm vào nút  <img src='img/1358023.png' width='16px'>  ở bên trái màng hình để chia sẽ qua Zalo)",
    ...
    "tất toán hụi sống": {
        ...
        "details": "<b>Bước 1:</b> Chọn vào mục <b>Chức năng</b>.<br><br>"
                   ...
                   "(Bấm vào nút  <img src='img/1358023.png' width='16px'>  ở bên trái màng hình để chia sẽ phiếu cho khách, bạn có thể chọn chia sẽ qua Zalo hoặc Messager cho khách hàng)",
    ...
    "tạo dây hụi góp": {
        ...
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   ...
                   "(Lưu ý, bạn phải đặt mục <b>Khui hụi/lần</b> từ 2 ngày trở lên)<br>"
                   "<list>"
    ...
    "mở dây hụi mãn trở lại đang hoạt động": {
        ...
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   ...
                   "<b>Bước 3:</b>Hệ thống sẽ hiện th các dây hụi đang bị mãn, hãy bấm vào dây hụi bạn muốn mở hoạt động lại.<br><br>"
    ...
    "mãn dây hụi": {
        "name": "mãn dây hụi",
        "details": "<b>Bước 1:</b> Bạn hãy chọn vào mục <b>QUẢN LÝ HỤI</b>.<br><br>"
                   "<b>Bước 3:</b>Bấm vào dây hụi bạn muốn mãn.<br><br>"
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if actions in ACTIONS_DATA:
            if actions == "tải phần mềm":
                ...
                video_link = ACTIONS_DATA[actions]["link"]
                message = (f"Để <b>{ACTIONS_DATA[actions]['name']}</b>, bạn hãy làm theo các bước hướng dẫn sau:<br><hr>"
                           f"{ACTIONS_DATA[actions]['details']}<br><hr>"
                           f"Hoặc bạn có thể xem video hướng dẫn sau để hiểu hơn <a href='{video_link}' target='_blank'>Xem Video</a>")
                dispatcher.utter_message(text=message)
        else:
